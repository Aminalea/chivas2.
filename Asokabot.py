# -*- coding: utf-8 -*-
# Edited from script ASOKABOT script made by ASOKA
from ASOKABOT import LineClient
from ASOKABOT.LineApi import   LineTracer
from ASOKABOT.LineThrift.ttypes import Message
from ASOKABOT.LineThrift.TalkService import Client
